...
Future<String> getExampleCode(String tag, String code) async {
  if (_exampleCode == null) await _parseExampleCode(code);
  return _exampleCode[tag];
}

Future<void> _parseExampleCode(String code) async {
