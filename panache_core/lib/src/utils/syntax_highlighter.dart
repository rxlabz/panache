...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle panacheThemeStyle() {
    return SyntaxHighlighterStyle(
        baseStyle:
            const TextStyle(color: Color(0xFFFFFF00), fontFamily: 'Roboto'),
        numberStyle:
            const TextStyle(color: Color(0xFF90DBD4), fontFamily: 'Roboto'),
        commentStyle:
            const TextStyle(color: Color(0xFF9E9E9E), fontFamily: 'Roboto'),
        keywordStyle:
            const TextStyle(color: Color(0xFFF06292), fontFamily: 'Roboto'),
        stringStyle:
            const TextStyle(color: Color(0xFFD4E157), fontFamily: 'Roboto'),
        punctuationStyle:
            const TextStyle(color: Color(0xFFFDD835), fontFamily: 'Roboto'),
        classStyle:
            const TextStyle(color: Color(0xFFFDD835), fontFamily: 'Roboto'),
        constantStyle:
            const TextStyle(color: Color(0xFF795548), fontFamily: 'Roboto'));
  }
